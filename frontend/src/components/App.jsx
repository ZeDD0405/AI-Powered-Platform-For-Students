  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/resume-analyser" element={<ProtectedRoute studentOnly><ResumeAnalyserPage /></ProtectedRoute>} />
        ...
        <Route path="/company-list/:branch" element={<ProtectedRoute><CompanyList /></ProtectedRoute>} />
        <Route path="/question-module/:branch/:company" element={<ProtectedRoute studentOnly><QuestionModule /></ProtectedRoute>} />
        <Route path="/view-questions/:branch/:company" element={<ProtectedRoute><ViewQuestions /></ProtectedRoute>} />
